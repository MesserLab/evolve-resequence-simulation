...
if (Type %in% c("QTL_architecture", "Experimental_design")){ # define filenames, plot title, and plot labels in the begining of the following loop 
  for (i in c(9:10)){
    ...
    filenames <-   list(c("NQTL10", "NQTL10_FewerSNPs")
                        ...
                        , c("NQTL100", "NQTL100_ESDistE", "NQTL100_20SelectedSize200", "NQTL100_20SelectedSize200ESDistE")
                        , c("NQTL100", "NQTL100")
                        , c("NQTL10", "NQTL10")
    )
...
png(paste0("~/evolve-resequence-simulation/Figures/figure_4.png"), width = 800*3, height = 750*2, units = "px", pointsize = 20)
print(figure_4)
dev.off()
jpeg(paste0("~/evolve-resequence-simulation/Figures/figure_4.jpeg"), width = 800*3, height = 750*2, units = "px", pointsize = 20)
print(figure_4)
dev.off()