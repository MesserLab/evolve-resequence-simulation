...
library(cowplot)
figure_s5 <- plot_grid(panel_a, panel_b, labels=c("A", "B"), nrow = 1, label_size=30) 
png(paste0("/fs/cbsubscb10/storage/rl683/TemporalScan/Figures/FiguresForPaper/Figure_S5.png"), width = 800*2, height = 750, units = "px", pointsize = 20)
print(figure_s5)
dev.off()
