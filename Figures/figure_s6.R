...
library(cowplot)
figure_s6 <- plot_grid(panel_4, panel_12, panel_1, panel_11,labels=c("A", "B", "C", "D"), nrow = 2, label_size=30)
png(paste0("~/evolve-resequence-simulation/Figures/figure_s6.png"), width = 800*2, height = 750*2, units = "px", pointsize = 20)
print(figure_s6)
dev.off()
