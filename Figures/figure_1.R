...
png(paste0("~/evolve-resequence-simulation/Figures/figure_1.png"), width = 800*3, height = 750*2, units = "px", pointsize = 20)
print(figure_1)
dev.off()
jpeg(paste0("~/evolve-resequence-simulation/Figures/figure_1.jpeg"), width = 800*3, height = 750*2, units = "px", pointsize = 20)
print(figure_1)
dev.off()
