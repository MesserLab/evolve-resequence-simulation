...
library(cowplot)
figure_5 <- plot_grid(panel_a, panel_b, panel_c, panel_d, panel_e, panel_f, labels=c("A", "B", "C", "D" ,"E", "F"), nrow = 2, label_size=30)

png(paste0("../../FiguresForPaper/Figure_5.png"), width = 800*3, height = 750*2, units = "px", pointsize = 20)
print(figure_5)
dev.off()
